...
const dict = {
  es: {
    ...
    'bias.center': 'Centro',
    'bias.right': 'Derecha',
    'bias.blindspot': 'Punto ciego',
    'bias.missingLeft': 'apenas cubierto por la izquierda',
    'bias.missingRight': 'apenas cubierto por la derecha',
  ...
  en: {
    ...
    'bias.center': 'Center',
    'bias.right': 'Right',
    'bias.blindspot': 'Blindspot',
    'bias.missingLeft': 'barely covered by the left',
    'bias.missingRight': 'barely covered by the right',
