...
const dict = {
  ...
  en: {
    ...
    'trends.ours': 'In your sources',
    'trends.window': 'Window',
    'trends.min': 'Min coverage',
    'trends.rail': 'Sidebar on front page',
    'trends.extSources': 'External sources',
    'trends.allTopics': 'All topics',
    'source.wikipedia': 'Wikipedia — most viewed',
    'source.mastodon': 'Mastodon — social',
    'source.google': 'Google — searches',
